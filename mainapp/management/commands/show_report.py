...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        action_2_time_delta = timedelta(days=11)
        ...
        action_2_condition = Q(order__updated__gt=F('order__created') + action_1_time_delta & Q(order__update__lte=F('order__created') + action_2_time_delta))

        action_3_condition = Q(order__updated_gt=F('order__created') + action_2_time_delta)
